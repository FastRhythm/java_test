 ...
 */
@Data
public class AttestDemo implements Serializable {
	...
	@Size(max=24, message = "文件名称不能超过24字符.")
	private String sourceFileName;

	/** [上链数据]文件类型 */
	@NotBlank(message="文件类型不能为空")
	@Size(max=4, message = "文件类型不能超过4字符..")
	private String sourceFileType;

	/** [上链数据]源文件长度 */
	@NotBlank(message="文件长度不能为空")
	@Size(max=6, message = "文件长度不能超过6字符.")
	...
	@Size(max=20, message = "权属人身份标识不能超过20字符.")
	...
	@Size(max=4, message = "存证时间长度不能超过4字符.")
