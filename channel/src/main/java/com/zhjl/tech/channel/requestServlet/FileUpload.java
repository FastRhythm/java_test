...
public class FileUpload {
    public boolean uploadFile(String URL,String signType, String sign,String accessKey, String random, String ordersn, String fileToken, String filepath){
        boolean fileCzresult = false;
        URI url = null;
        try {
